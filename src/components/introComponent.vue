...
<style scoped>
    ...
    .intro-properties__info p {
        text-align: center;
    }
    
    .intro-properties__info p:first-child {
        font-weight: 700;
        text-transform: uppercase;
    }
    
    .intro-properties__info p:last-child {
        margin-top: 10px;
